...
const service = require('../services/mqtttopicService');
const util = require('../util');

const viewDir = 'mqtttopic';
const moduleRoute = '/mqtttopic';
const titleWord = 'MQTT Topic'
...
exports.createPost = async (req, res) => {
    try {
        ...
        let validationResult = validator.validate(obj, 'mqtttopic', 'create');
